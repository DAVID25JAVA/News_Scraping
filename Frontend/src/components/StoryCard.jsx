      ...
      <div className="flex items-start justify-between gap-5">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm text-gray-500">🔥 245 Points</span>
          </div>
          ...
          <p className="text-gray-600 mt-4 leading-relaxed">
            Developers are discussing the latest advancements in AI reasoning
            systems and how they impact modern software development.
          </p>
        </div>

        <Button className="whitespace-nowrap">Bookmark</Button>
      </div>
